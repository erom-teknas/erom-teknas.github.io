...
![get-pods](/assets/images/aws/vpc/VPC.drawio.png){: width="700" height="300" .shadow .light }
...
![VPC](/assets/images/aws/vpc/vpc-create.png){: width="700" height="300" .shadow .light }
...
![Subnets](/assets/images/aws/vpc/subnet-create.png){: width="700" height="300" .shadow .light }
...
![Main RT](/assets/images/aws/vpc/main-RT.png){: width="700" height="300" .shadow .light }
![alt text](/assets/images/aws/vpc/main-RT-darkmode.png){: width="700" height="400" .shadow .dark }
![Main routes](/assets/images/aws/vpc/main-routes.png){: width="700" height="300" .shadow .light }
...
![Private RT](/assets/images/aws/vpc/route-table-create.png){: width="700" height="300" .shadow .light }
![alt text](/assets/images/aws/vpc/route-table-create-darkmode.png){: width="700" height="400" .shadow .dark }
![Private routes](/assets/images/aws/vpc/privateroutes.png){: width="700" height="300" .shadow .light }
...
### Internet gateway
![IGW](/assets/images/aws/vpc/igw.png){: width="700" height="300" .shadow .light }
...
![PrivateEC2](/assets/images/aws/vpc/ec2pri-vpc.png){: width="700" height="300" .shadow .light }
![alt text](/assets/images/aws/vpc/ec2pri-vpc-darkmode.png){: width="700" height="400" .shadow .dark }
![PrivateEC2](/assets/images/aws/vpc/privateec2.png){: width="700" height="300" .shadow .light }
...
![PrivateBrowser](/assets/images/aws/vpc/privateBrowser.png){: width="700" height="300" .shadow .light }
...
![PrivateBrowser](/assets/images/aws/vpc/ec2pub.png){: width="700" height="300" .shadow .light }
